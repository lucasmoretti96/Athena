    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        arquivo.createDirect();
            ...
            if (result.next()) {
                ...
                arquivo.WriteLog("Logado com Sucesso no " + data2 + "na hora " + hora2+".");
                mensagem.enviarMensagem("Um usuário acabou de se conectar.");
            } else {
                JOptionPane.showMessageDialog(rootPane, "ERRO!");
               arquivo.WriteLog("Falha ao logar no " + data2 + " na hora " + hora2);
                mensagem.enviarMensagem("Houve uma tentativa de logar.");
                arquivo.WriteLog("-------------------------");
            }
